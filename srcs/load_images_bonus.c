...
/*   Updated: 2020/01/30 14:28:57 by jheras-f         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_load_paths(t_cub3d *t)
{
	...
	t->map.sprite = ft_check_paths(t->map.sprite, "./images/enemy3.xpm");
	t->map.sprite2 = ft_check_paths(t->map.sprite2, "./images/enemy2.xpm");
}
...
static void	ft_load_walls(t_cub3d *t, int a, int b)
{
	...
	t->img[7].im = mlx_xpm_file_to_image(t->ptr, "./images/door.xpm", &a, &b);
...
void		ft_load_images(t_cub3d *t)
{
	...
	ft_load_paths(t);
	ft_load_walls(t, a, b);
	t->img[1].im = mlx_xpm_file_to_image(t->ptr, "images/sky_day.xpm", &a, &b);
	...
	t->img[8].im = mlx_xpm_file_to_image(t->ptr, "./images/health.xpm", &a, &b);
	t->img[8].ptr = mlx_get_data_addr(t->img[8].im, &t->img[8].bpp,
			&t->img[8].szln, &t->img[8].endian);
	t->img[9].im = mlx_xpm_file_to_image(t->ptr, "./images/weapon.xpm", &a, &b);
	t->img[9].ptr = mlx_get_data_addr(t->img[9].im, &t->img[9].bpp,
			&t->img[9].szln, &t->img[9].endian);
	t->img[10].im = mlx_xpm_file_to_image(t->ptr, "./images/hud_2.xpm", &a, &b);
	t->img[10].ptr = mlx_get_data_addr(t->img[10].im, &t->img[10].bpp,
			&t->img[10].szln, &t->img[10].endian);
}
